...
dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-black text-black dark:text-white">
      ...
      {/* Contact Info Cards */}
      <div className="max-w-7xl mx-auto px-6 -mt-18 relative z-10 mb-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white dark:bg-[#1a2332] p-8 rounded-2xl border border-[#1c5cbd] hover:border-red-500 transition-all duration-300 text-center group"
            >
              <div className="text-orange-500 mb-4 flex justify-center group-hover:scale-110 transition-transform duration-300">
                {item.icon}
              </div>
              <h3 className="text-xl font-bold mb-3">{item.title}</h3>
              <p className="text-slate-500 mb-1">{item.info}</p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <div className="mb-10">
              ...
              <h2 className="text-4xl font-bold mt-4 mb-4">
                Let's Start <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500">a conversetaion</span>
              </h2>
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold mb-2 text-slate-500">Your Name</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                    ...
                    className="w-full bg-[#1a2332] border border-slate-700 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:border-orange-500 focus:outline-none transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-2 text-slate-500">Email Address</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold mb-2 text-slate-500">Phone Number</label>
                  <input
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label className="block text-sm font-semibold mb-2 text-slate-500">Subject</label>
                  <input
                    type="text"
                    name="subject"
              ...
              <div>
                <label className="block text-sm font-semibold mb-2 text-slate-500">Your Message</label>
                <textarea
                  name="message"
                  ...
                  rows="6"
                  className="w-full bg-[#1a2332] border border-slate-700 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:border-orange-500 focus:outline-none transition-colors resize-none"
                ></textarea>
              </div>

              <button
                onClick={handleSubmit}
                className="w-full bg-[#f9652f] text-white py-5 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 transform hover:scale-[1.02]"
              >
                Send Message →
              </button>
            </div>
          ...
          >
            {/* Map */}
            <div className="bg-[#1a2332] rounded-2xl overflow-hidden border border-[#1c5cbd] h-[400px]">
              <iframe
            ...
            {/* Additional Info */}
            <div className="bg-white dark:bg-[#1a2332] p-8 rounded-2xl border border-[#1c5cbd]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mt-4">
              Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500">Quentions</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white dark:bg-[#1a2332] p-6 rounded-xl border border-[#1c5cbd]"
              >
