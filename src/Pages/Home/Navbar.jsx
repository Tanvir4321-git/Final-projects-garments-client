    ...
    <div className='bg-black shadow-sm '>
      <div className="navbar w-11/12 mx-auto ">
        ...
        <div className="navbar-end">
          ...
          {
             loading?<span className="loading text-[#f9652f] loading-dots loading-xl"></span>: user?<>    <img className='rounded-[100%] w-10 mr-4 border border-[#f9652f]' src={user?user.photoURL:profile} alt="" />  <motion.div
