                    ...
                    <div className="card-body text-white">
                        <form >
                            ...
                            <fieldset className="fieldset text-white text-[18px]">
                                ...
                                <input type="password" className="input bg-transparent" placeholder="Password" />
                                ...
                                >
                                    <Link className=' button  my-4 py-2 px-2 md:px-4 text-[14px] md:text-[17px] gap-2 flex justify-center' >Log in <button className='arrow py-2 px-3 '><FaArrowRight className='size-2 md:size-3' /></button></Link>
                                </motion.div>
